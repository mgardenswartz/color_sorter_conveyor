 ...
 * @brief   Library for the SparkFun APDS-9960 breakout board ported to the STM32
 * @author  Shawn Hymel (SparkFun Electronics) and Max Gardenswartz (STM32 port)
 *
...
public:
    ...
    SparkFun_APDS9960(I2C_HandleTypeDef* I2C_handle);
    ~SparkFun_APDS9960();
    bool init();
    uint8_t getMode();
