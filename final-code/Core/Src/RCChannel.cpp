/**
 * @file RCChannel.cpp
 * @brief Creates an RC channel object on the STM32F411CUE6 that can be used to read PWM signals from a remote control car receiver.
 * 
 ...
 * Make sure to adjust the code underneath HAL_TIM_IC_CaptureCallback and to enable interrupts for the configured pins' timer channels.
 * 
 * @param pin_group Pin group macro like GPIOA or GPIOB for the receiver signal pin.
 * @param pin Pin number like GPIO_PIN_9 for the receiver singal pin.
